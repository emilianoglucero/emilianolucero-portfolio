...
export const Projects = ({ info }) => {
  ...
  return (
    <div
      className={`video-card flex flex-col flex-1 m-auto overflow-hidden skew-y-12 rounded shadow-lg my-11 hover:shadow-md hover:bg-primary ${colStartClass} ${colSpanClass} ${rowStartClass}`}
    >
      <VideoCard info={info} />
